      ...
      {projects.map((project) => (
        <li key={project.url}>
          <a
            href={project.url}
            target="_blank"
            className="group block rounded-md border border-neutral-700 bg-neutral-900 px-4 py-2 text-neutral-500 transition hover:bg-neutral-800 hover:text-neutral-300">
