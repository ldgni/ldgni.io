    ...
    <header className="mb-8 flex items-center justify-between">
      ...
      <div className="flex gap-2">
        <a
          ...
          className="rounded-xl p-1 text-neutral-500 transition-colors hover:bg-neutral-300 hover:text-dark sm:p-2 dark:hover:bg-neutral-800 dark:hover:text-light">
          <Github />
        </a>
        <a
