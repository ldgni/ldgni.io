      ...
      {projects.map((project) => (
        <li key={project.url}>
          <a
            href={project.url}
            target="_blank"
            className="group block rounded-lg border border-neutral-400 px-4 py-2 saturate-0 transition hover:bg-neutral-200 hover:saturate-100 focus:bg-neutral-200 focus:saturate-100 focus:outline-none active:bg-neutral-200 active:saturate-100 dark:border-neutral-600 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800 dark:active:bg-neutral-800">
