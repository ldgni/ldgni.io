    ...
    <ul className="space-y-6">
      {posts.map((post) => (
        <li key={post.url}>
          <Link
            href={post.url}
            className="group flex flex-col gap-2 rounded-lg border border-neutral-300 p-3 transition-colors hover:bg-neutral-200 sm:flex-row sm:justify-between dark:border-neutral-700 dark:hover:bg-neutral-800">
